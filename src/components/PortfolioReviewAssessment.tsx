...
interface PortfolioReviewAssessmentProps {
...
export const PortfolioReviewAssessment = ({
  ...
  // Filter to only portfolio_review assessments and sort by creation time descending
    ...
    <>
      <Card>
        <CardHeader className="flex flex-row items-center justify-between">
          <CardTitle>Portfolio Review Assessment</CardTitle>
          {isAdmin && (
        ...
        <CardContent>
          {assessments.length === 0 ? (
            <p className="text-muted-foreground text-center py-4">
              No portfolio review assessments yet.
      ...
      <AlertDialog open={!!deletingId} onOpenChange={() => setDeletingId(null)}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              This will permanently delete this portfolio review assessment and all its
